---
title: "Modelisation of opinion through space and time"
---
...
```{r}
hc2<-hc[!Oijt %in% c("DK","Refused"), .(i,j,t,Ait,Sij,Wit,Fijt=Oijt %in% c("Very favorable","Somewhat favorable")) ]
head(hc2)
```
...
### Variation of opinion from origin countries (i)
...
### Variation of opinion about target countries (j)
...
### Variation of global opinions throught time (t)
...
### Cross analysis of j through i:t
